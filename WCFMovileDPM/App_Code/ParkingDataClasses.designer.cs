...
public partial class ParkingDataClassesDataContext : System.Data.Linq.DataContext
{
  ...
  partial void Deletereservation(reservation instance);
	...
	public System.Data.Linq.Table<disctrict> disctrict
	{
		get
		{
	...
	public System.Data.Linq.Table<parkingLot> parkingLot
	{
		get
		{
	...
	public System.Data.Linq.Table<parkingSpace> parkingSpace
	{
		get
		{
...
public partial class department : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="department_province", Storage="_province", ThisKey="departmentId", OtherKey="departmentId")]
...
public partial class user : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<provider> _provider;
	...
	public user()
	{
		this._provider = new EntitySet<provider>(new Action<provider>(this.attach_provider), new Action<provider>(this.detach_provider));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_provider", Storage="_provider", ThisKey="userID", OtherKey="userID")]
	public EntitySet<provider> provider
	{
		get
		{
		...
		set
		{
			this._provider.Assign(value);
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_reservation", Storage="_reservation", ThisKey="userID", OtherKey="userID")]
	...
	private void attach_provider(provider entity)
	{
		this.SendPropertyChanging();
		entity.user = this;
	}
	
	private void detach_provider(provider entity)
	{
		this.SendPropertyChanging();
		entity.user = null;
	}
		...
		set
		{
						...
						|| (this._province.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.disctrict.Remove(this);
				}
				this._province.Entity = value;
				if ((value != null))
				{
					value.disctrict.Add(this);
...
public partial class parkingLot : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<parkingSpace> _parkingSpace;
	...
	public parkingLot()
	{
		this._parkingSpace = new EntitySet<parkingSpace>(new Action<parkingSpace>(this.attach_parkingSpace), new Action<parkingSpace>(this.detach_parkingSpace));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="parkingLot_parkingSpace", Storage="_parkingSpace", ThisKey="parkingLotID", OtherKey="parkingLotID")]
	public EntitySet<parkingSpace> parkingSpace
	{
		get
		{
		...
		set
		{
			this._parkingSpace.Assign(value);
		}
	}
		...
		set
		{
						...
						|| (this._provider.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.parkingLot.Remove(this);
				}
				this._provider.Entity = value;
				if ((value != null))
				{
					value.parkingLot.Add(this);
	...
	private void attach_parkingSpace(parkingSpace entity)
	{
		this.SendPropertyChanging();
		entity.parkingLot = this;
	}
	
	private void detach_parkingSpace(parkingSpace entity)
	{
		this.SendPropertyChanging();
...
public partial class parkingSpace : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="parkingSpace_reservation", Storage="_reservation", ThisKey="parkingSpaceID", OtherKey="parkingSpaceID")]
	public EntitySet<reservation> reservation
	{
		get
		{
		...
		set
		{
						...
						|| (this._parkingLot.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.parkingSpace.Remove(this);
				}
				this._parkingLot.Entity = value;
				if ((value != null))
				{
					value.parkingSpace.Add(this);
...
public partial class provider : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<parkingLot> _parkingLot;
	...
	public provider()
	{
		this._parkingLot = new EntitySet<parkingLot>(new Action<parkingLot>(this.attach_parkingLot), new Action<parkingLot>(this.detach_parkingLot));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="provider_parkingLot", Storage="_parkingLot", ThisKey="providerID", OtherKey="providerID")]
	public EntitySet<parkingLot> parkingLot
	{
		get
		{
	...
	private void attach_parkingLot(parkingLot entity)
	{
		this.SendPropertyChanging();
		entity.provider = this;
	}
	
	private void detach_parkingLot(parkingLot entity)
	{
		this.SendPropertyChanging();
...
public partial class province : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<disctrict> _disctrict;
	...
	public province()
	{
		this._disctrict = new EntitySet<disctrict>(new Action<disctrict>(this.attach_disctrict), new Action<disctrict>(this.detach_disctrict));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="province_disctrict", Storage="_disctrict", ThisKey="provinceId", OtherKey="provinceId")]
	public EntitySet<disctrict> disctrict
	{
		get
		{
			return this._disctrict;
		}
		set
		{
			this._disctrict.Assign(value);
		}
	}
	...
	private void attach_disctrict(disctrict entity)
	{
		this.SendPropertyChanging();
		entity.province = this;
	}
	
	private void detach_disctrict(disctrict entity)
	{
		this.SendPropertyChanging();
